    ...
    >
      <div className="space-y-[20px]">
        ...
        <div className="grid grid-cols-2 gap-[21px]">
          ...
          <div className="bg-[#1B1328] rounded-[16px] p-[20px] h-[172px]">
            <img src="/images/icons/user-flow.svg" alt="" className="w-[40px] h-[40px] mb-[10px]" />
            <h3 className="text-[#F5F5F5] font-medium text-[20px] leading-[1.2em] mb-[8px]" style={{ fontFamily: 'Roboto' }}>
          ...
          <div className="bg-[#1B1328] rounded-[16px] p-[20px] h-[172px]">
            <img src="/images/icons/target.svg" alt="" className="w-[40px] h-[40px] mb-[10px]" />
            <h3 className="text-[#F5F5F5] font-medium text-[20px] leading-[1.2em] mb-[8px]" style={{ fontFamily: 'Roboto' }}>
          ...
          <div className="bg-[#1B1328] rounded-[16px] p-[20px] h-[172px]">
            <img src="/images/icons/rocket.svg" alt="" className="w-[40px] h-[40px] mb-[10px]" />
            <h3 className="text-[#F5F5F5] font-medium text-[20px] leading-[1.2em] mb-[8px]" style={{ fontFamily: 'Roboto' }}>
          ...
          <div className="bg-[#1B1328] rounded-[16px] p-[20px] h-[172px]">
            <img src="/images/icons/headphones.svg" alt="" className="w-[30px] h-[30px] mb-[10px]" />
            <h3 className="text-[#F5F5F5] font-medium text-[20px] leading-[1.2em] mb-[8px]" style={{ fontFamily: 'Roboto' }}>
          ...
          <div className="bg-[#1B1328] rounded-[16px] p-[20px] h-[172px]">
            <img src="/images/icons/handshake.svg" alt="" className="w-[40px] h-[40px] mb-[10px]" />
            <h3 className="text-[#F5F5F5] font-medium text-[20px] leading-[1.2em] mb-[8px]" style={{ fontFamily: 'Roboto' }}>
          ...
          <div className="bg-[#1B1328] rounded-[16px] p-[20px] h-[172px]">
            <img src="/images/icons/layers.svg" alt="" className="w-[30px] h-[30px] mb-[10px]" />
            <h3 className="text-[#F5F5F5] font-medium text-[20px] leading-[1.2em] mb-[8px]" style={{ fontFamily: 'Roboto' }}>
          ...
          <div className="bg-[#1B1328] rounded-[16px] p-[20px] h-[172px]">
            <img src="/images/icons/shield.svg" alt="" className="w-[30px] h-[30px] mb-[10px]" />
            <h3 className="text-[#F5F5F5] font-medium text-[20px] leading-[1.2em] mb-[8px]" style={{ fontFamily: 'Roboto' }}>
          ...
          <div className="bg-[#1B1328] rounded-[16px] p-[20px] h-[172px]">
            <img src="/images/icons/graph.svg" alt="" className="w-[32px] h-[32px] mb-[10px]" />
            <h3 className="text-[#F5F5F5] font-medium text-[20px] leading-[1.2em] mb-[8px]" style={{ fontFamily: 'Roboto' }}>
